...
hold off;
print -depsc2 ./CoolingSystemExample_X.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_Y.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_Xhist.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_Yhist.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_autocorrX.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_autocorrY.eps
close;
...
hold off;
print -depsc2 ./CoolingSystemExample_LandLCC.eps
close;

%% GC, TE, and PAI results (no print to terminal, no plots)

[TE,GC,PAI,L,LCC,g] = ECA(x,y,xtol,ytol,LCClags,10,1,true,false);
