...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_X.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_Y.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_Xhist.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_Yhist.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_autocorrX.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_autocorrY.eps
close;
...
hold off;
print -depsc2 ./NoisyCyclicResponseExample_LandLCC.eps
close;
...
% 
%     hold off;
%     print('-depsc2',sprintf('./NoisyCyclicResponseExample_lagplotXYl%i.eps',cplots_iter));
%     close;
%     
%     figure('Units', 'inches', ...
%     'Position', [0 0 width height],...
...
% 
%     hold off;
%     print('-depsc2',sprintf('./NoisyCyclicResponseExample_lagplotYXl%i.eps',cplots_iter));
%     close;
% end;
...
% 
% hold off;
% print('-depsc2','./NoisyCyclicResponseExample_leandifftoll1.eps');
% close;
% 
% figure('Units', 'inches', ...
% 'Position', [0 0 width height],...
...
% 
% hold off;
% print('-depsc2','./NoisyCyclicResponseExample_leandifftoll5.eps');
% close;

%% Create ECA guess plot

load NoisyCyclicImpulseExample_20150902.mat
...
hold off;
print('-depsc2','./NoisyCyclicResponseExample_ECAguessMat.eps');
close;