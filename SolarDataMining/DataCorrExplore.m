...
ParamDim = 3;
for Lradius = 1:90,
    Dst_e_Flux_CCM(Lradius,1) = CCM(Dst_index_daily,MeV_e_Flux(:,Lradius),ParamDim);
    Dst_e_Flux_CCM(Lradius,2) = CCM(MeV_e_Flux(:,Lradius),Dst_index_daily,ParamDim);
    Sunspot_e_Flux_CCM(Lrad2ius,1) = CCM(Sunspot_number_daily,MeV_e_Flux(:,Lradius),ParamDim);
    Sunspot_e_Flux_CCM(Lrad2ius,2) = CCM(MeV_e_Flux(:,Lradius),Sunspot_number_daily,ParamDim);
    Plasma_e_Flux_CCM(Lradius,1) = CCM(Plasma_bulk_speed_daily,MeV_e_Flux(:,Lradius),ParamDim);
    Plasma_e_Flux_CCM(Lradius,2) = CCM(MeV_e_Flux(:,Lradius),Plasma_bulk_speed_daily,ParamDim);
    Bz_e_Flux_CCM(Lradius,1) = CCM(Bz_GSE_daily,MeV_e_Flux(:,Lradius),ParamDim);
    Bz_e_Flux_CCM(Lradius,2) = CCM(MeV_e_Flux(:,Lradius),Bz_GSE_daily,ParamDim);
end
Dst_Sunspot_CCM(1) = CCM(Dst_index_daily,Sunspot_number_daily,ParamDim);   
Dst_Sunspot_CCM(2) = CCM(Sunspot_number_daily,Dst_index_daily,ParamDim); 
Dst_Plasma_CCM(1) = CCM(Dst_index_daily,Plasma_bulk_speed_daily,ParamDim);   
Dst_Plasma_CCM(2) = CCM(Plasma_bulk_speed_daily,Dst_index_daily,ParamDim);   
Dst_Bz_CCM(1) = CCM(Dst_index_daily,Bz_GSE_daily,ParamDim);   
Dst_Bz_CCM(2) = CCM(Bz_GSE_daily,Dst_index_daily,ParamDim);  
