...
\caption{$N$ samples with $\left(\mu_{rx},\mu_{ry},\sigma^2_{rx},\sigma^2_{ry},\mu_{x0},\mu_{y0},\sigma^2_{x0},\sigma^2_{y0}\right) = \left(\ldots\right)$ and $\left(E,\tau\right)=\left(3,1\right)$ for $L=\ldots$.}
\end{figure}
