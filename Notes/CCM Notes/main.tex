...
\dot{I} = \frac{V}{L} - \frac{R}{L} I\;\;,
$$
where $I$ is the current, $V$ is the voltage, $R$ is the resistance, and $L$ is the inductance, but with both $V$ and $R$ as time-dependent parameters.  Consider, for example, that the resistance $R$ is provided by a transitor\footnote{http://arxiv.org/ftp/arxiv/papers/0708/0708.3498.pdf}  The driving time series will then be both the voltage $V$ and the resistance $R$, and the response times series will still be the current $I$.  Only the inductance will be considered fixed.
...
%\includegraphics[scale=1]{RL_RvarySig1.eps}
\caption{$L = 10$}
\end{subfigure}
\begin{subfigure}[b]{0.4\textwidth}
\label{fig:RL_RvarySig1ZOOM}
%\includegraphics[scale=1]{RL_RvarySig1ZOOM.eps}
\caption{$L = 10$.  Zoomed in area of plot on the left.}
\end{subfigure}
\caption{}
\end{figure}
...
%\includegraphics[scale=1]{RL_RvarySig1CCMVR.eps}
\caption{$L = 10$ and $V$, $R$ given in Figure  \ref{fig:RL_RvarySig1}.}
\end{subfigure}
\begin{subfigure}[b]{0.25\textwidth}
...
\caption{}
\end{figure}
These results imply that $V\rightarrow I$ and $R\rightarrow I$ with no directed correlation between $V$ and $R$.  These results agree with intuition.  
...
%\includegraphics[scale=1]{RL_RvarySig2CCMVR.eps}
\caption{$L = 10$ and $V$, $R$ given in text.}
\end{subfigure}
\begin{subfigure}[b]{0.25\textwidth}
