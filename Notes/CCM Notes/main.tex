...
%\includegraphics[scale=0.55]{TwoPopSamplByxBxy.eps}
...
$$
which leads to ``driving'' rules similar to those mentioned for $\Delta$ at the beginning of this section (i.e.\ $D_{\theta n}<1/2\rightarrow$ ``$X$ drives $Y$'', $D_{\theta n}>1/2\rightarrow$ ``$Y$ drives $X$'', and $\Delta=1/2$ indicates no directed correlation in the system).  
