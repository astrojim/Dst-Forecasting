...
\begin{eqnarray}
P(y_t=0 \cap x_t = 0) &=& \frac{4}{25}\\
P(y_t=1 \cap x_t = 0) &=& \frac{4}{25}\\
P(y_t=2 \cap x_t = 0) &=& \frac{2}{25}\\
P(y_t=0 \cap x_t = 1) &=& \frac{4}{25}\\
P(y_t=1 \cap x_t = 1) &=& \frac{4}{25}\\
P(y_t=2 \cap x_t = 1) &=& \frac{2}{25}\\
P(y_t=0 \cap x_t = 2) &=& \frac{2}{25}\\
P(y_t=1 \cap x_t = 2) &=& \frac{2}{25}\\
P(y_t=2 \cap x_t = 2) &=& \frac{1}{25}
\end{eqnarray}
...
\begin{center}
\begin{tabular}{c|c|c}
$P(y_t=0 | x_t = 0) = \frac{P(y_t=0 \cap x_t = 0)}{P(x_t = 0)} = \frac{2}{5}$ &
$P(y_t=0 | x_t = 1) = \frac{P(y_t=0 \cap x_t = 1)}{P(x_t = 1)} = \frac{2}{5}$ &
$P(y_t=0 | x_t = 2) = \frac{P(y_t=0 \cap x_t = 2)}{P(x_t = 2)} = \frac{2}{5}$ \\

$P(y_t=1 | x_t = 0) = \frac{P(y_t=1 \cap x_t = 0)}{P(x_t = 0)} = \frac{2}{5}$ &
$P(y_t=1 | x_t = 1) = \frac{P(y_t=1 \cap x_t = 1)}{P(x_t = 1)} = \frac{2}{5}$ &
$P(y_t=1 | x_t = 2) = \frac{P(y_t=1 \cap x_t = 2)}{P(x_t = 2)} = \frac{2}{5}$ \\

$P(y_t=2 | x_t = 0) = \frac{P(y_t=2 \cap x_t = 0)}{P(x_t = 0)} = \frac{1}{5}$ &
$P(y_t=2 | x_t = 1) = \frac{P(y_t=2 \cap x_t = 1)}{P(x_t = 1)} = \frac{1}{5}$ &
$P(y_t=2 | x_t = 2) = \frac{P(y_t=2 \cap x_t = 2)}{P(x_t = 2)} = \frac{1}{5}$ \\
\hline \\
$P(x_t=0 | y_t = 0) = \frac{P(y_t=0 \cap x_t = 0)}{P(y_t = 0)} = \frac{2}{5}$ &
$P(x_t=0 | y_t = 1) = \frac{P(y_t=0 \cap x_t = 1)}{P(y_t = 1)} = \frac{2}{5}$ &
$P(x_t=0 | y_t = 2) = \frac{P(y_t=0 \cap x_t = 2)}{P(y_t = 2)} = \frac{2}{5}$ \\

$P(x_t=1 | y_t = 0) = \frac{P(y_t=1 \cap x_t = 0)}{P(y_t = 0)} = \frac{2}{5}$ &
$P(x_t=1 | y_t = 1) = \frac{P(y_t=1 \cap x_t = 1)}{P(y_t = 1)} = \frac{2}{5}$ &
$P(x_t=1 | y_t = 2) = \frac{P(y_t=1 \cap x_t = 2)}{P(y_t = 2)} = \frac{2}{5}$ \\

$P(x_t=2 | y_t = 0) = \frac{P(y_t=2 \cap x_t = 0)}{P(y_t = 0)} = \frac{1}{5}$ &
$P(x_t=2 | y_t = 1) = \frac{P(y_t=2 \cap x_t = 1)}{P(y_t = 1)} = \frac{1}{5}$ &
$P(x_t=2 | y_t = 2) = \frac{P(y_t=2 \cap x_t = 2)}{P(y_t = 2)} = \frac{1}{5}$ \\
\end{tabular}
\end{center}
Consider the penchant
$$
\rho_{xy} = P(x_t = 0 | y_t = 0) - P(x_t = 0 | y_t \neq 0) = \frac{2}{5} - \frac{4}{5} = -\frac{2}{5}
$$
and its partner
$$
...
&=& \frac{1}{9}\left[ -\frac{2}{5} - \frac{2}{5} - \frac{2}{5} -\frac{2}{5}-\frac{2}{5}-\frac{2}{5}-\frac{1}{5}-\frac{1}{5}-\frac{1}{5}\right] \\
&=& - \frac{12}{45}
\end{eqnarray}
