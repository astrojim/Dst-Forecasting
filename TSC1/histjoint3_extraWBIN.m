function [tsteps_struct,counts] = histjoint3_extraWBIN(TSdataX,TSdataY,TSdatadX,...
    binUpperX,binLowerX,binUpperY,binLowerY,binUpperdX,binLowerdX)
...
counts = zeros(nbins,nbins,nbins);
